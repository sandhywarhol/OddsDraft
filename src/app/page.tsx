...
function ScheduleSection() {
  ...
  return (
    <section id="schedule-section" style={{ padding: '60px 0', background: '#111827' }}>
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 800 }}>Match Schedule</h2>
              ...
              <div key={match.fixtureId} className="card" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 24px' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    ...
                    <span style={{ fontWeight: 700, fontSize: '1.2rem' }}>{match.homeTeam}</span>
                    <span style={{ margin: '0 12px', color: 'var(--text-secondary)' }}>vs</span>
                    <span style={{ fontWeight: 700, fontSize: '1.2rem' }}>{match.awayTeam}</span>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 12 }}>
                  ...
                  {match.status !== 'upcoming' && (
                    <div style={{ fontFamily: 'Bebas Neue, cursive', fontSize: '1.5rem', letterSpacing: '0.1em' }}>
