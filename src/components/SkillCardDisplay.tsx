...
export default function SkillCardDisplay({
  ...
  const posColor =
    ...
    card.position === 'Winger'     ? '#00838f' : '#6a1b9a'; // Striker
  ...
  return (
    ...
    >
      ...
      {/* ── SKILL NAME — in rarity-colored box ── */}
      <div style={{
        position: 'absolute',
        top: '58.5%',
        left: '20%',
      ...
      <div style={{
        ...
        <span style={{ color: '#5a3a10', opacity: 0.8, fontStyle: 'italic', display: 'block' }}>
          {card.flavorText}
        </span>
        <span style={{ fontWeight: 700, color: '#2c1a06', marginTop: 2, display: 'block' }}>
